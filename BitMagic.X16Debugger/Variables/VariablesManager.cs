...
internal class VariableManager
{
    ...
    public void SetupVariables()
    {
        ...
        scope.AddVariable(new VariableMemory("Current Buffer", () => $"{_emulator.Spi.SendLength} bytes", "sdcardblock", () => _emulator.SpiOutboundBuffer.Slice(0, (int)_emulator.Spi.SendLength).ToArray()));
