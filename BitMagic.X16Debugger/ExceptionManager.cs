...
internal class ExceptionManager
{
    ...
    internal ExceptionManager(X16Debug adapter)
    {
    ...
    {
        //SysThread thread = this.adapter.ThreadManager.GetThread(args.ThreadId);
        //if (thread == null)
        //{
        //    output.AppendLine($"Unknown thread id '{args.ThreadId}'!");
        //    return false;
        //}
        ...
        //else
        //{
        //    output.AppendLine($"Ignoring exception '{args.ExceptionId}' due to configuration.");
        //}
